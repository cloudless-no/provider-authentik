...
type SourceInitParameters struct {
	...
	// Defaults to `false`.
	DeleteNotFoundObjects *bool `json:"deleteNotFoundObjects,omitempty" tf:"delete_not_found_objects,omitempty"`
	...
	// (Boolean) Defaults to true.
	// Defaults to `true`.
	LookupGroupsFromUser *bool `json:"lookupGroupsFromUser,omitempty" tf:"lookup_groups_from_user,omitempty"`
	...
	// (List of String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/namespaced/ldap/v1alpha1.SourcePropertyMapping
	...
	// References to SourcePropertyMapping in ldap to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupRefs []v1.NamespacedReference `json:"propertyMappingsGroupRefs,omitempty" tf:"-"`

	// Selector for a list of SourcePropertyMapping in ldap to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupSelector *v1.NamespacedSelector `json:"propertyMappingsGroupSelector,omitempty" tf:"-"`

	// References to SourcePropertyMapping in ldap to populate propertyMappings.
	// +kubebuilder:validation:Optional
	PropertyMappingsRefs []v1.NamespacedReference `json:"propertyMappingsRefs,omitempty" tf:"-"`

	// Selector for a list of SourcePropertyMapping in ldap to populate propertyMappings.
	// +kubebuilder:validation:Optional
	...
	// (String) Defaults to distinguishedName.
	// Defaults to `distinguishedName`.
	UserMembershipAttribute *string `json:"userMembershipAttribute,omitempty" tf:"user_membership_attribute,omitempty"`
