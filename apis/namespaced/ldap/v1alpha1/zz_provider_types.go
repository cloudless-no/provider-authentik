...
type ProviderInitParameters struct {
	...
	// Reference to a Flow in flows to populate bindFlow.
	// +kubebuilder:validation:Optional
	BindFlowRef *v1.NamespacedReference `json:"bindFlowRef,omitempty" tf:"-"`

	// Selector for a Flow in flows to populate bindFlow.
	// +kubebuilder:validation:Optional
	BindFlowSelector *v1.NamespacedSelector `json:"bindFlowSelector,omitempty" tf:"-"`
	...
	// Reference to a Flow in flows to populate unbindFlow.
	// +kubebuilder:validation:Optional
	UnbindFlowRef *v1.NamespacedReference `json:"unbindFlowRef,omitempty" tf:"-"`

	// Selector for a Flow in flows to populate unbindFlow.
	// +kubebuilder:validation:Optional
	UnbindFlowSelector *v1.NamespacedSelector `json:"unbindFlowSelector,omitempty" tf:"-"`
}
