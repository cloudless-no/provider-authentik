...
type SourceInitParameters struct {
	...
	// References to SourcePropertyMapping in oauth to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupRefs []v1.NamespacedReference `json:"propertyMappingsGroupRefs,omitempty" tf:"-"`

	// Selector for a list of SourcePropertyMapping in oauth to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
