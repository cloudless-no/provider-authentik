...
type GroupInitParameters struct {
	...
	// Generated.
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/namespaced/users/v1alpha1.User
	Users []*float64 `json:"users,omitempty" tf:"users,omitempty"`

	// References to User in users to populate users.
	// +kubebuilder:validation:Optional
	UsersRefs []v1.NamespacedReference `json:"usersRefs,omitempty" tf:"-"`

	// Selector for a list of User in users to populate users.
	// +kubebuilder:validation:Optional
