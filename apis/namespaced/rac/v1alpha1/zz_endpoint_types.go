...
type EndpointInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/namespaced/rac/v1alpha1.Provider
	ProtocolProvider *float64 `json:"protocolProvider,omitempty" tf:"protocol_provider,omitempty"`

	// Reference to a Provider in rac to populate protocolProvider.
	// +kubebuilder:validation:Optional
	ProtocolProviderRef *v1.NamespacedReference `json:"protocolProviderRef,omitempty" tf:"-"`

	// Selector for a Provider in rac to populate protocolProvider.
	// +kubebuilder:validation:Optional
