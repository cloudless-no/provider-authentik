...
type ProviderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/namespaced/microsoftentra/v1alpha1.ProviderPropertyMapping
	...
	// References to ProviderPropertyMapping in microsoftentra to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupRefs []v1.NamespacedReference `json:"propertyMappingsGroupRefs,omitempty" tf:"-"`

	// Selector for a list of ProviderPropertyMapping in microsoftentra to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupSelector *v1.NamespacedSelector `json:"propertyMappingsGroupSelector,omitempty" tf:"-"`

	// References to ProviderPropertyMapping in microsoftentra to populate propertyMappings.
	// +kubebuilder:validation:Optional
