...
func (mg *Outpost) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this Outpost.
func (mg *Outpost) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *Outpost) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this Outpost.
func (mg *Outpost) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
