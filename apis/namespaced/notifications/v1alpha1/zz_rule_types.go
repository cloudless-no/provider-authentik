...
type RuleInitParameters struct {
	...
	DestinationGroupRef *v1.NamespacedReference `json:"destinationGroupRef,omitempty" tf:"-"`

	// Selector for a Group in users to populate destinationGroup.
	// +kubebuilder:validation:Optional
	DestinationGroupSelector *v1.NamespacedSelector `json:"destinationGroupSelector,omitempty" tf:"-"`
