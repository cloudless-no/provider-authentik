...
type ApplicationInitParameters struct {
	...
	// Reference to a Provider in oauth2 to populate protocolProvider.
	// +kubebuilder:validation:Optional
	ProtocolProviderRef *v1.NamespacedReference `json:"protocolProviderRef,omitempty" tf:"-"`

	// Selector for a Provider in oauth2 to populate protocolProvider.
	// +kubebuilder:validation:Optional
	ProtocolProviderSelector *v1.NamespacedSelector `json:"protocolProviderSelector,omitempty" tf:"-"`
