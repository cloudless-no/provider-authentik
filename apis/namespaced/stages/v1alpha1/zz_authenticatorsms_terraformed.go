...
func (tr *AuthenticatorSms) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"account_sid": "accountSidSecretRef", "auth": "authSecretRef", "auth_password": "authPasswordSecretRef"}
}
...
// GetInitParameters of this AuthenticatorSms
func (tr *AuthenticatorSms) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
