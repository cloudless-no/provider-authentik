...
type UserWriteInitParameters struct {
	...
	// (String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/namespaced/users/v1alpha1.Group
	CreateUsersGroup *string `json:"createUsersGroup,omitempty" tf:"create_users_group,omitempty"`

	// Reference to a Group in users to populate createUsersGroup.
	// +kubebuilder:validation:Optional
	CreateUsersGroupRef *v1.NamespacedReference `json:"createUsersGroupRef,omitempty" tf:"-"`

	// Selector for a Group in users to populate createUsersGroup.
	// +kubebuilder:validation:Optional
	CreateUsersGroupSelector *v1.NamespacedSelector `json:"createUsersGroupSelector,omitempty" tf:"-"`
