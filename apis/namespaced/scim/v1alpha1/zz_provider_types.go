...
type ProviderInitParameters struct {
	...
	// (List of String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/namespaced/scim/v1alpha1.ProviderPropertyMapping
	...
	// References to ProviderPropertyMapping in scim to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupRefs []v1.NamespacedReference `json:"propertyMappingsGroupRefs,omitempty" tf:"-"`

	// Selector for a list of ProviderPropertyMapping in scim to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupSelector *v1.NamespacedSelector `json:"propertyMappingsGroupSelector,omitempty" tf:"-"`

	// References to ProviderPropertyMapping in scim to populate propertyMappings.
	// +kubebuilder:validation:Optional
	PropertyMappingsRefs []v1.NamespacedReference `json:"propertyMappingsRefs,omitempty" tf:"-"`

	// Selector for a list of ProviderPropertyMapping in scim to populate propertyMappings.
	// +kubebuilder:validation:Optional
