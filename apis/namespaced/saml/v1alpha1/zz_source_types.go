...
type SourceInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	EnrollmentFlowRef *v1.NamespacedReference `json:"enrollmentFlowRef,omitempty" tf:"-"`

	// Selector for a Flow in flows to populate enrollmentFlow.
	// +kubebuilder:validation:Optional
	EnrollmentFlowSelector *v1.NamespacedSelector `json:"enrollmentFlowSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	PreAuthenticationFlowRef *v1.NamespacedReference `json:"preAuthenticationFlowRef,omitempty" tf:"-"`
	...
	// References to SourcePropertyMapping in saml to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupRefs []v1.NamespacedReference `json:"propertyMappingsGroupRefs,omitempty" tf:"-"`

	// Selector for a list of SourcePropertyMapping in saml to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupSelector *v1.NamespacedSelector `json:"propertyMappingsGroupSelector,omitempty" tf:"-"`

	// References to SourcePropertyMapping in saml to populate propertyMappings.
	// +kubebuilder:validation:Optional
	PropertyMappingsRefs []v1.NamespacedReference `json:"propertyMappingsRefs,omitempty" tf:"-"`

	// Selector for a list of SourcePropertyMapping in saml to populate propertyMappings.
	// +kubebuilder:validation:Optional
