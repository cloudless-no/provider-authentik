...
type IdentificationInitParameters struct {
	...
	// (String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/cluster/stages/v1alpha1.Captcha
	...
	// (String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/cluster/stages/v1alpha1.Password
