...
type PromptInitParameters struct {
	...
	// (List of String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/cluster/stages/v1alpha1.PromptField
	Fields []*string `json:"fields,omitempty" tf:"fields,omitempty"`

	// References to PromptField in stages to populate fields.
	// +kubebuilder:validation:Optional
	FieldsRefs []v1.Reference `json:"fieldsRefs,omitempty" tf:"-"`

	// Selector for a list of PromptField in stages to populate fields.
	// +kubebuilder:validation:Optional
	FieldsSelector *v1.Selector `json:"fieldsSelector,omitempty" tf:"-"`
