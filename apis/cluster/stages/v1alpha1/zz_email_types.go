...
type EmailInitParameters struct {
	...
	RecoveryCacheTimeout *string `json:"recoveryCacheTimeout,omitempty" tf:"recovery_cache_timeout,omitempty"`

	// (Number) Defaults to 5.
	// Defaults to `5`.
	RecoveryMaxAttempts *float64 `json:"recoveryMaxAttempts,omitempty" tf:"recovery_max_attempts,omitempty"`
