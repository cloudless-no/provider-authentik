...
type UserWriteInitParameters struct {
	...
	// (String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/cluster/users/v1alpha1.Group
	...
	CreateUsersGroupRef *v1.Reference `json:"createUsersGroupRef,omitempty" tf:"-"`

	// Selector for a Group in users to populate createUsersGroup.
	// +kubebuilder:validation:Optional
	CreateUsersGroupSelector *v1.Selector `json:"createUsersGroupSelector,omitempty" tf:"-"`
