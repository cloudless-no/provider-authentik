...
type OutpostInitParameters struct {
	...
	// (List of Number)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/cluster/proxy/v1alpha1.Provider
	...
	ProtocolProvidersRefs []v1.Reference `json:"protocolProvidersRefs,omitempty" tf:"-"`

	// Selector for a list of Provider in proxy to populate protocolProviders.
	// +kubebuilder:validation:Optional
	ProtocolProvidersSelector *v1.Selector `json:"protocolProvidersSelector,omitempty" tf:"-"`

	// (String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/cluster/k8s/v1alpha1.ServiceConnection
